        ...
        if df_raw.empty:
            ...
            if df.empty:
                ...
                total_row = pd.DataFrame([{
                    "CALLER": "TOTAL", "IN/OUT TIME": "-", "TEAM": "-", "CALL STATUS": "-", "PICK UP RATIO %": "-",
                ...
                st.dataframe(final_df.style.set_properties(**{'white-space': 'pre-wrap'}), 
